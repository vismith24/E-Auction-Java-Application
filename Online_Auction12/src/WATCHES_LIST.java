 ...
 * @author user
 */
public class WATCHES_LIST extends javax.swing.JFrame {

    /**
     * Creates new form WATCHES_LIST
     */
    public WATCHES_LIST() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(184, 20, 40, 30));

        jLabel2.setFont(new java.awt.Font("MV Boli", 3, 14)); // NOI18N
        jLabel2.setText("WATCHES LIST");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 150, 20));

        jRadioButton1.setText("ROLEX  YatchMaster");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WATCHES_LIST.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
